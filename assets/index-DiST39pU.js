...
(function(module, exports) {
  ((e2, t2) => {
    ...
    var d, s = !n2.document && !!n2.postMessage, a = n2.IS_PAPA_WORKER || false, o = {}, h = 0, v2 = {};
    function u2(e2) {
      this._handle = null, this._finished = false, this._completed = false, this._halted = false, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = true, this._completeResults = { data: [], errors: [], meta: {} }, (function(e3) {
        ...
        if (this.isFirstChunk && 0 < i2) {
          ...
          e4 || (r3 = this._config.quoteChar || '"', e4 = this._handle.guessLineEndings(t2, r3)), t2 = [...t2.split(e4).slice(i2)].join(e4);
        }
        this.isFirstChunk && P2(this._config.beforeFirstChunk) && void 0 !== (r3 = this._config.beforeFirstChunk(t2)) && (t2 = r3), this.isFirstChunk = false, this._halted = false;
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          ...
          if (a) n2.postMessage({ results: r3, workerId: v2.WORKER_ID, finished: i2 });
          else if (P2(this._config.chunk) && !e3) {
          ...
          return this._config.step || this._config.chunk || (this._completeResults.data = this._completeResults.data.concat(r3.data), this._completeResults.errors = this._completeResults.errors.concat(r3.errors), this._completeResults.meta = r3.meta), this._completed || !i2 || !P2(this._config.complete) || r3 && r3.meta.aborted || (this._config.complete(this._completeResults, this._input), this._completed = true), i2 || r3 && r3.meta.paused || this._nextChunk(), r3;
        }
        this._halted = true;
      }, this._sendError = function(e3) {
        P2(this._config.error) ? this._config.error(e3) : a && this._config.error && n2.postMessage({ workerId: v2.WORKER_ID, error: e3, finished: false });
      };
    }
    function f2(e2) {
      var r3;
      (e2 = e2 || {}).chunkSize || (e2.chunkSize = v2.RemoteChunkSize), u2.call(this, e2), this._nextChunk = s ? function() {
        ...
        if (this._finished) this._chunkLoaded();
          ...
          if (r3 = new XMLHttpRequest(), this._config.withCredentials && (r3.withCredentials = this._config.withCredentials), s || (r3.onload = y2(this._chunkLoaded, this), r3.onerror = y2(this._chunkError, this)), r3.open(this._config.downloadRequestBody ? "POST" : "GET", this._input, !s), this._config.downloadRequestHeaders) {
    ...
    function l2(e2) {
      ...
      this.stream = function(e3) {
        this._input = e3, r3 = e3.slice || e3.webkitSlice || e3.mozSlice, n3 ? ((i2 = new FileReader()).onload = y2(this._chunkLoaded, this), i2.onerror = y2(this._chunkError, this)) : i2 = new FileReaderSync(), this._nextChunk();
      }, this._nextChunk = function() {
        this._finished || this._config.preview && !(this._rowCount < this._config.preview) || this._readChunk();
      }, this._readChunk = function() {
        var e3 = this._input, t2 = (this._config.chunkSize && (t2 = Math.min(this._start + this._config.chunkSize, this._input.size), e3 = r3.call(e3, this._start, t2)), i2.readAsText(e3, this._config.encoding));
    ...
    function c(e2) {
      ...
      u2.call(this, e2 = e2 || {}), this.stream = function(e3) {
        ...
        var e3, t2;
        if (!this._finished) return e3 = this._config.chunkSize, i2 = e3 ? (t2 = i2.substring(0, e3), i2.substring(e3)) : (t2 = i2, ""), this._finished = !i2, this.parseChunk(t2);
      };
    }
    function p2(e2) {
      u2.call(this, e2 = e2 || {});
      ...
      this.pause = function() {
        ...
        try {
          t2.push("string" == typeof e3 ? e3 : e3.toString(this._config.encoding)), i2 && (i2 = false, this._checkIsFinished(), this.parseChunk(t2.shift()));
        } catch (e4) {
    ...
    function i(m3) {
      var n3, s2, a2, t2, o2 = Math.pow(2, 53), h2 = -o2, u3 = /^\s*-?(\d+\.?|\.\d+|\d+\.\d+)([eE][-+]?\d+)?\s*$/, d2 = /^((\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z)))$/, i2 = this, r3 = 0, f3 = 0, l3 = false, e2 = false, c2 = [], p3 = { data: [], errors: [], meta: {} };
      function y3(e3) {
        return "greedy" === m3.skipEmptyLines ? "" === e3.join("").trim() : 1 === e3.length && 0 === e3[0].length;
      }
      function g2() {
        if (p3 && a2 && (k2("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + v2.DefaultDelimiter + "'"), a2 = false), m3.skipEmptyLines && (p3.data = p3.data.filter(function(e4) {
          return !y3(e4);
        })), _2()) {
          let t4 = function(e4, t5) {
            P2(m3.transformHeader) && (e4 = m3.transformHeader(e4, t5)), c2.push(e4);
          };
          var t3 = t4;
          if (p3) if (Array.isArray(p3.data[0])) {
            for (var e3 = 0; _2() && e3 < p3.data.length; e3++) p3.data[e3].forEach(t4);
            p3.data.splice(0, 1);
          } else p3.data.forEach(t4);
        }
        function i3(e4, t4) {
          for (var i4 = m3.header ? {} : [], r5 = 0; r5 < e4.length; r5++) {
            var n4 = r5, s3 = e4[r5], s3 = ((e5, t5) => ((e6) => (m3.dynamicTypingFunction && void 0 === m3.dynamicTyping[e6] && (m3.dynamicTyping[e6] = m3.dynamicTypingFunction(e6)), true === (m3.dynamicTyping[e6] || m3.dynamicTyping)))(e5) ? "true" === t5 || "TRUE" === t5 || "false" !== t5 && "FALSE" !== t5 && (((e6) => {
              if (u3.test(e6)) {
                e6 = parseFloat(e6);
                if (h2 < e6 && e6 < o2) return 1;
              }
          ...
          return m3.header && (r5 > c2.length ? k2("FieldMismatch", "TooManyFields", "Too many fields: expected " + c2.length + " fields but parsed " + r5, f3 + t4) : r5 < c2.length && k2("FieldMismatch", "TooFewFields", "Too few fields: expected " + c2.length + " fields but parsed " + r5, f3 + t4)), i4;
        }
        var r4;
        p3 && (m3.header || m3.dynamicTyping || m3.transform) && (r4 = 1, !p3.data.length || Array.isArray(p3.data[0]) ? (p3.data = p3.data.map(i3), r4 = p3.data.length) : p3.data = i3(p3.data, 0), m3.header && p3.meta && (p3.meta.fields = c2), f3 += r4);
      }
      function _2() {
        return m3.header && 0 === c2.length;
      }
      function k2(e3, t3, i3, r4) {
        e3 = { type: e3, code: t3, message: i3 };
        void 0 !== r4 && (e3.row = r4), p3.errors.push(e3);
      }
      P2(m3.step) && (t2 = m3.step, m3.step = function(e3) {
        p3 = e3, _2() ? g2() : (g2(), 0 !== p3.data.length && (r3 += e3.data.length, m3.preview && r3 > m3.preview ? s2.abort() : (p3.data = p3.data[0], t2(p3, i2))));
      }), this.parse = function(e3, t3, i3) {
        var r4 = m3.quoteChar || '"', r4 = (m3.newline || (m3.newline = this.guessLineEndings(e3, r4)), a2 = false, m3.delimiter ? P2(m3.delimiter) && (m3.delimiter = m3.delimiter(e3), p3.meta.delimiter = m3.delimiter) : ((r4 = ((e4, t4, i4, r5, n4) => {
          var s3, a3, o3, h3;
          n4 = n4 || [",", "	", "|", ";", v2.RECORD_SEP, v2.UNIT_SEP];
          for (var u4 = 0; u4 < n4.length; u4++) {
            for (var d3, f4 = n4[u4], l4 = 0, c3 = 0, p4 = 0, g3 = (o3 = void 0, new E2({ comments: r5, delimiter: f4, newline: t4, preview: 10 }).parse(e4)), _3 = 0; _3 < g3.data.length; _3++) i4 && y3(g3.data[_3]) ? p4++ : (d3 = g3.data[_3].length, c3 += d3, void 0 === o3 ? o3 = d3 : 0 < d3 && (l4 += Math.abs(d3 - o3), o3 = d3));
            0 < g3.data.length && (c3 /= g3.data.length - p4), (void 0 === a3 || l4 <= a3) && (void 0 === h3 || h3 < c3) && 1.99 < c3 && (a3 = l4, s3 = f4, h3 = c3);
          }
          return { successful: !!(m3.delimiter = s3), bestDelimiter: s3 };
        })(e3, m3.newline, m3.skipEmptyLines, m3.comments, m3.delimitersToGuess)).successful ? m3.delimiter = r4.bestDelimiter : (a2 = true, m3.delimiter = v2.DefaultDelimiter), p3.meta.delimiter = m3.delimiter), w2(m3));
        return m3.preview && m3.header && r4.preview++, n3 = e3, s2 = new E2(r4), p3 = s2.parse(n3, t3, i3), g2(), l3 ? { meta: { paused: true } } : p3 || { meta: { paused: false } };
      }, this.paused = function() {
        return l3;
      }, this.pause = function() {
        l3 = true, s2.abort(), n3 = P2(m3.chunk) ? "" : n3.substring(s2.getCharIndex());
      }, this.resume = function() {
        i2.streamer._halted ? (l3 = false, i2.streamer.parseChunk(n3, true)) : setTimeout(i2.resume, 3);
      }, this.aborted = function() {
        return e2;
      }, this.abort = function() {
        e2 = true, s2.abort(), p3.meta.aborted = true, P2(m3.complete) && m3.complete(p3), n3 = "";
      }, this.guessLineEndings = function(e3, t3) {
        e3 = e3.substring(0, 1048576);
        var t3 = new RegExp(M2(t3) + "([^]*?)" + M2(t3), "gm"), i3 = (e3 = e3.replace(t3, "")).split("\r"), t3 = e3.split("\n"), e3 = 1 < t3.length && t3[0].length < i3[0].length;
    ...
    function E2(C2) {
      var S2 = (C2 = C2 || {}).delimiter, O2 = C2.newline, x2 = C2.comments, I2 = C2.step, A2 = C2.preview, T2 = C2.fastMode, D2 = null, L2 = null == C2.quoteChar ? '"' : C2.quoteChar, F2 = L2;
      if (void 0 !== C2.escapeChar && (F2 = C2.escapeChar), ("string" != typeof S2 || -1 < v2.BAD_DELIMITERS.indexOf(S2)) && (S2 = ","), x2 === S2) throw new Error("Comment character same as delimiter");
      true === x2 ? x2 = "#" : ("string" != typeof x2 || -1 < v2.BAD_DELIMITERS.indexOf(x2)) && (x2 = false), "\n" !== O2 && "\r" !== O2 && "\r\n" !== O2 && (O2 = "\n");
      var j2 = 0, z2 = false;
      this.parse = function(i2, t2, r3) {
        if ("string" != typeof i2) throw new Error("Input must be a string");
        var n3 = i2.length, e2 = S2.length, s2 = O2.length, a2 = x2.length, o2 = P2(I2), h2 = [], u3 = [], d2 = [], f3 = j2 = 0;
        if (!i2) return b();
        if (T2 || false !== T2 && -1 === i2.indexOf(L2)) {
          for (var l3 = i2.split(O2), c2 = 0; c2 < l3.length; c2++) {
            if (d2 = l3[c2], j2 += d2.length, c2 !== l3.length - 1) j2 += O2.length;
            else if (r3) return b();
            if (!x2 || d2.substring(0, a2) !== x2) {
              if (o2) {
                if (h2 = [], k2(d2.split(S2)), R2(), z2) return b();
              } else k2(d2.split(S2));
              if (A2 && A2 <= c2) return h2 = h2.slice(0, A2), b(true);
            }
          }
          return b();
        }
        for (var p3 = i2.indexOf(S2, j2), g2 = i2.indexOf(O2, j2), _2 = new RegExp(M2(F2) + M2(L2), "g"), m3 = i2.indexOf(L2, j2); ; ) if (i2[j2] === L2) for (m3 = j2, j2++; ; ) {
          if (-1 === (m3 = i2.indexOf(L2, m3 + 1))) return r3 || u3.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: h2.length, index: j2 }), E3();
          if (m3 === n3 - 1) return E3(i2.substring(j2, m3).replace(_2, L2));
          if (L2 === F2 && i2[m3 + 1] === F2) m3++;
          else if (L2 === F2 || 0 === m3 || i2[m3 - 1] !== F2) {
            -1 !== p3 && p3 < m3 + 1 && (p3 = i2.indexOf(S2, m3 + 1));
            var y3 = v3(-1 === (g2 = -1 !== g2 && g2 < m3 + 1 ? i2.indexOf(O2, m3 + 1) : g2) ? p3 : Math.min(p3, g2));
            if (i2.substr(m3 + 1 + y3, e2) === S2) {
              d2.push(i2.substring(j2, m3).replace(_2, L2)), i2[j2 = m3 + 1 + y3 + e2] !== L2 && (m3 = i2.indexOf(L2, j2)), p3 = i2.indexOf(S2, j2), g2 = i2.indexOf(O2, j2);
              break;
            }
            y3 = v3(g2);
            if (i2.substring(m3 + 1 + y3, m3 + 1 + y3 + s2) === O2) {
              if (d2.push(i2.substring(j2, m3).replace(_2, L2)), w3(m3 + 1 + y3 + s2), p3 = i2.indexOf(S2, j2), m3 = i2.indexOf(L2, j2), o2 && (R2(), z2)) return b();
              if (A2 && h2.length >= A2) return b(true);
              break;
            }
            u3.push({ type: "Quotes", code: "InvalidQuotes", message: "Trailing quote on quoted field is malformed", row: h2.length, index: j2 }), m3++;
          }
        }
        else if (x2 && 0 === d2.length && i2.substring(j2, j2 + a2) === x2) {
          if (-1 === g2) return b();
          j2 = g2 + s2, g2 = i2.indexOf(O2, j2), p3 = i2.indexOf(S2, j2);
        } else if (-1 !== p3 && (p3 < g2 || -1 === g2)) d2.push(i2.substring(j2, p3)), j2 = p3 + e2, p3 = i2.indexOf(S2, j2);
        else {
          if (-1 === g2) break;
          if (d2.push(i2.substring(j2, g2)), w3(g2 + s2), o2 && (R2(), z2)) return b();
          if (A2 && h2.length >= A2) return b(true);
        }
        return E3();
        function k2(e3) {
        ...
        function v3(e3) {
          var t3 = 0;
          return t3 = -1 !== e3 && (e3 = i2.substring(m3 + 1, e3)) && "" === e3.trim() ? e3.length : t3;
        }
        function E3(e3) {
          return r3 || (void 0 === e3 && (e3 = i2.substring(j2)), d2.push(e3), j2 = n3, k2(d2), o2 && R2()), b();
        }
        function w3(e3) {
          j2 = e3, k2(d2), d2 = [], g2 = i2.indexOf(O2, j2);
        }
        function b(e3) {
          if (C2.header && !t2 && h2.length) {
            var s3 = h2[0], a3 = {}, o3 = new Set(s3);
            let n4 = false;
            for (let r4 = 0; r4 < s3.length; r4++) {
              let i3 = s3[r4];
              if (a3[i3 = P2(C2.transformHeader) ? C2.transformHeader(i3, r4) : i3]) {
                let e4, t3 = a3[i3];
                for (; e4 = i3 + "_" + t3, t3++, o3.has(e4); ) ;
                o3.add(e4), s3[r4] = e4, a3[i3]++, n4 = true, (D2 = null === D2 ? {} : D2)[e4] = i3;
              } else a3[i3] = 1, s3[r4] = i3;
              o3.add(i3);
            }
            n4 && console.warn("Duplicate headers found and renamed.");
          }
          return { data: h2, errors: u3, meta: { delimiter: S2, linebreak: O2, aborted: z2, truncated: !!e3, cursor: f3 + (t2 || 0), renamedHeaders: D2 } };
        }
        function R2() {
          I2(b()), h2 = [], u3 = [];
        }
    ...
    function g(e2) {
      var t2 = e2.data, i2 = o[t2.workerId], r3 = false;
      if (t2.error) i2.userError(t2.error, t2.file);
        ...
        if (P2(i2.userStep)) {
          ...
          delete t2.results;
        } else P2(i2.userChunk) && (i2.userChunk(t2.results, n3, t2.file), delete t2.results);
      }
      t2.finished && !r3 && _(t2.workerId, t2.results);
    }
    function _(e2, t2) {
      var i2 = o[e2];
      P2(i2.userComplete) && i2.userComplete(t2), i2.terminate(), delete o[e2];
    }
    function m2() {
    ...
    function w2(e2) {
      ...
      var t2, i2 = Array.isArray(e2) ? [] : {};
      for (t2 in e2) i2[t2] = w2(e2[t2]);
      return i2;
    }
    function y2(e2, t2) {
      return function() {
    ...
    return v2.parse = function(e2, t2) {
      ...
      P2(i2) && (t2.dynamicTypingFunction = i2, i2 = {});
      if (t2.dynamicTyping = i2, t2.transform = !!P2(t2.transform) && t2.transform, !t2.worker || !v2.WORKERS_SUPPORTED) return i2 = null, v2.NODE_STREAM_INPUT, "string" == typeof e2 ? (e2 = ((e3) => 65279 !== e3.charCodeAt(0) ? e3 : e3.slice(1))(e2), i2 = new (t2.download ? f2 : c)(t2)) : true === e2.readable && P2(e2.read) && P2(e2.on) ? i2 = new p2(t2) : (n2.File && e2 instanceof File || e2 instanceof Object) && (i2 = new l2(t2)), i2.stream(e2);
      (i2 = (() => {
        var e3;
        ...
        })(), (e3 = new n2.Worker(e3)).onmessage = g, e3.id = h++, o[e3.id] = e3);
      })()).userStep = t2.step, i2.userChunk = t2.chunk, i2.userComplete = t2.complete, i2.userError = t2.error, t2.step = P2(t2.step), t2.chunk = P2(t2.chunk), t2.complete = P2(t2.complete), t2.error = P2(t2.error), delete t2.worker, i2.postMessage({ input: e2, config: t2, workerId: i2.id });
    }, v2.unparse = function(e2, t2) {
      var n3 = false, _2 = true, m3 = ",", y3 = "\r\n", s2 = '"', a2 = s2 + s2, i2 = false, r3 = null, o2 = false, h2 = ((() => {
        if ("object" == typeof t2) {
          if ("string" != typeof t2.delimiter || v2.BAD_DELIMITERS.filter(function(e3) {
            return -1 !== t2.delimiter.indexOf(e3);
          }).length || (m3 = t2.delimiter), "boolean" != typeof t2.quotes && "function" != typeof t2.quotes && !Array.isArray(t2.quotes) || (n3 = t2.quotes), "boolean" != typeof t2.skipEmptyLines && "string" != typeof t2.skipEmptyLines || (i2 = t2.skipEmptyLines), "string" == typeof t2.newline && (y3 = t2.newline), "string" == typeof t2.quoteChar && (s2 = t2.quoteChar), "boolean" == typeof t2.header && (_2 = t2.header), Array.isArray(t2.columns)) {
            if (0 === t2.columns.length) throw new Error("Option columns is empty");
            r3 = t2.columns;
          }
          void 0 !== t2.escapeChar && (a2 = t2.escapeChar + s2), t2.escapeFormulae instanceof RegExp ? o2 = t2.escapeFormulae : "boolean" == typeof t2.escapeFormulae && t2.escapeFormulae && (o2 = /^[=+\-@\t\r].*$/);
        }
      })(), new RegExp(M2(s2), "g"));
      ...
      function u3(e3, t3, i3) {
        var r4 = "", n4 = ("string" == typeof e3 && (e3 = JSON.parse(e3)), "string" == typeof t3 && (t3 = JSON.parse(t3)), Array.isArray(e3) && 0 < e3.length), s3 = !Array.isArray(t3[0]);
        if (n4 && _2) {
          for (var a3 = 0; a3 < e3.length; a3++) 0 < a3 && (r4 += m3), r4 += k2(e3[a3], a3);
          0 < t3.length && (r4 += y3);
        }
        for (var o3 = 0; o3 < t3.length; o3++) {
          var h3 = (n4 ? e3 : t3[o3]).length, u4 = false, d2 = n4 ? 0 === Object.keys(t3[o3]).length : 0 === t3[o3].length;
          ...
          if (!u4) {
            ...
            o3 < t3.length - 1 && (!i3 || 0 < h3 && !d2) && (r4 += y3);
          }
        }
        return r4;
      }
      function k2(e3, t3) {
        var i3, r4;
        return null == e3 ? "" : e3.constructor === Date ? JSON.stringify(e3).slice(1, 25) : (r4 = false, o2 && "string" == typeof e3 && o2.test(e3) && (e3 = "'" + e3, r4 = true), i3 = e3.toString().replace(h2, a2), (r4 = r4 || true === n3 || "function" == typeof n3 && n3(e3, t3) || Array.isArray(n3) && n3[t3] || ((e4, t4) => {
          for (var i4 = 0; i4 < t4.length; i4++) if (-1 < e4.indexOf(t4[i4])) return true;
          return false;
        })(i3, v2.BAD_DELIMITERS) || -1 < i3.indexOf(m3) || " " === i3.charAt(0) || " " === i3.charAt(i3.length - 1)) ? s2 + i3 + s2 : i3);
      }
    }, v2.RECORD_SEP = String.fromCharCode(30), v2.UNIT_SEP = String.fromCharCode(31), v2.BYTE_ORDER_MARK = "\uFEFF", v2.BAD_DELIMITERS = ["\r", "\n", '"', v2.BYTE_ORDER_MARK], v2.WORKERS_SUPPORTED = !s && !!n2.Worker, v2.NODE_STREAM_INPUT = 1, v2.LocalChunkSize = 10485760, v2.RemoteChunkSize = 5242880, v2.DefaultDelimiter = ",", v2.Parser = E2, v2.ParserHandle = i, v2.NetworkStreamer = f2, v2.FileStreamer = l2, v2.StringStreamer = c, v2.ReadableStreamStreamer = p2, n2.jQuery && ((d = n2.jQuery).fn.parse = function(o2) {
      var i2 = o2.config || {}, h2 = [];
      return this.each(function(e3) {
        ...
        for (var t2 = 0; t2 < this.files.length; t2++) h2.push({ file: this.files[t2], inputElem: this, instanceConfig: d.extend({}, i2) });
      }), e2(), this;
      function e2() {
        if (0 === h2.length) P2(o2.complete) && o2.complete();
        else {
          var e3, t2, i3, r3, n3 = h2[0];
          if (P2(o2.before)) {
            var s2 = o2.before(n3.file, n3.inputElem);
            if ("object" == typeof s2) {
              if ("abort" === s2.action) return e3 = "AbortError", t2 = n3.file, i3 = n3.inputElem, r3 = s2.reason, void (P2(o2.error) && o2.error({ name: e3 }, t2, i3, r3));
          ...
          n3.instanceConfig.complete = function(e4) {
            P2(a2) && a2(e4, n3.file, n3.inputElem), u3();
    ...
    }), (f2.prototype = Object.create(u2.prototype)).constructor = f2, (l2.prototype = Object.create(u2.prototype)).constructor = l2, (c.prototype = Object.create(c.prototype)).constructor = c, (p2.prototype = Object.create(u2.prototype)).constructor = p2, v2;
  });
})(papaparse_min);
...
const loadPapers = () => {
  ...
  return parsedData.map((record) => {
    const paper = {
      title: record.title,
      authors: record.authors.split(";").filter((author) => author.trim() !== "").map((author) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container max-w-3xl mx-auto py-12 px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose prose-lg max-w-none overflow-visible", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:flow-root relative overflow-visible", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden max-sm:block float-right ml-4 mb-4 w-32 h-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base sm:text-lg text-secondary mb-4", children: [
          ...
          " in 2016 with  ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "text-blue-400", href: "http://homes.cs.washington.edu/~seitz/", children: "Steve Seitz" }),
          " as my advisor. Two of my PhD projects went viral online:  ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "text-blue-400", href: "https://grail.cs.washington.edu/projects/timelapse/", children: "timelapse mining from Internet photos" }),
          ", and a  ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "text-blue-400", href: "https://medium.com/hackernoon/seattle-3-year-time-lapse-video-from-the-space-needle-9a9e76cfe8bf", children: "timelapse of Seattle from the Space Needle" }),
          ".  I hold two bachelor degrees in Math and Informatics from ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 justify-center", children: [
...
const App = () => /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TooltipProvider, { children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { basename: "rmbrualla-site", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Index, {}) }) }) })
] }) });
